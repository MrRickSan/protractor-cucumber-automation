...
let VegasPage = require("../page_objects/vegas-page")
let VegasLoginPage = require("../page_objects/vegas-login-page")
...
var VegasSteps = function () {
        ...
        let vegasPage = new VegasPage()
        let vegasLoginPage = new VegasLoginPage()
